"""
Script to save safetensors from cpkt
"""
...
def create_safetensors_from_cpkt(model_path: str, output_path: str):
    """
...
if __name__ == "__main__":
    model_path = (
        "/data/smartspim_tissue_segmentation/smartspim_tissue_segmentation.ckpt"
    )
    output_path = "/results"
